...
paint1 <- paint.plot %>% layout(title = "Paintings", xaxis = x, yaxis = y)

htmlwidgets::saveWidget(paint1, file = "paint1.html", selfcontained = TRUE)
```
```{html}
<iframe seamless src="~Documents/iX_Data_Science/blog2/paint1.html" width="100%" height="500"></iframe>
```
